...
export interface ApiCartCart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    lines: Schema.Attribute.Component<'cart.cart-line', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiCollectionCollection extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Product collection/category';
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bodySummary: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    handle: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    descriptionHtml: Schema.Attribute.RichText;
    ...
    > &
      Schema.Attribute.Private;
    options: Schema.Attribute.Component<'product.product-option', true>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
